...
<Card className="w-full max-w-6xl p-6 bg-gradient-to-r from-indigo-100 to-purple-100 shadow-md rounded-xl">
          <h2 className="text-xl text-center item-center font-semibold text-indigo-700 mb-4">Today's Revision Schedule</h2>
